...
| [Хеши](https://codeforces.com/gym/359876) | 15.12.2021 12:50 | 14:00:00 | 1 | 2 | 3
...
1. Графы: Алгоритм Дейкстры, Форда-Беллмана, Форда-Фалкерсона [[Конспект](./lecture19-shortest-paths), [Видео](https://youtu.be/IO5pk38Dbh0), [Разбор](https://youtu.be/yM5pRW3Xdn8)]
1. Графы: Топологическая сортировка и компоненты сильной связности [[Конспект](./lecture20-scc), [Видео](https://youtu.be/zwutaDeRBeU), [Разбор](https://youtu.be/XRfPr5g72lU)]
1. Структуры данных: Префиксные суммы. Sparse table. Дерево отрезков-1 [[Конспект](./lecture21-structures), [Видео](https://youtu.be/4mIP_KD_vU0)]
1. Структуры данных:  Дерево отрезков-2. Дерево Фенвика [[Конспект](./lecture22-structures), [Видео](https://youtu.be/IyVyLrhxp70)]
1. Строки: хеши [[Конспект](./lecture23-hashes)]
1. Корневая декомпозиция
...
1. Графы: мосты и точки сочленения
