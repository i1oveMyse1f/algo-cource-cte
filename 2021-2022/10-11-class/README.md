...
1. Графы: Алгоритм Дейкстры, Форда-Беллмана, Форда-Фалкерсона [[Конспект](./lecture19-shortest-paths), [Видео](https://youtu.be/IO5pk38Dbh0)]
1. Графы: Топологическая сортировка и компоненты сильной связности [[Конспект](./lecture20-scc), [Видео](https://youtu.be/zwutaDeRBeU)]
